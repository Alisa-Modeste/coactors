...
from py2neo.printer import Printer
...
class NodeMatch(object):
    ...
    def __len__(self):
        ...
        #     return self.graph.evaluate(kwargs['raw_query'])
        ...
        #     """MATCH (t:Title) WHERE t.uid IN [78964]  
        #        MATCH (_:Actor) WHERE _.uid IN ['56', 32] RETURN count(_)""", {})
    ...
    def __iter__(self):
        ...
        # 
            ...
            # for record in self.graph.run("MATCH (_:Actor) WHERE _.uid IN ['56', 32] RETURN _", {}):
        # for record in self.graph.run(
        #     """MATCH (t:Title) WHERE t.uid IN [78964] 
        #        MATCH (_:Actor) WHERE _.uid IN ['56', 32] RETURN _""", {}):
                Printer.ready("what are in these records anyway?",record)
                yield record[0]
    ...
    def all(self):
        ...
        *New in version 2020.0.*
        ...
        #         Printer.ready(f"self attr ",attr)
        return list(self)
    ...
    def raw_query(self, query):
        ...
        *New in version 2020.0.*
        """
        # return list({"before":self,"after":query})
        # return self.graph.evaluate("MATCH (_:Actor) RETURN count(_)")
