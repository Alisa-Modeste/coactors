...
class Bolt3(Bolt2):
    ...
    def ready(self, the_object ):
        ...
        # # pprint(stack[1][0])
        # # pprint(stack[1][1]) #bolt4x1
        # pprint(stack[0][0])#ready()
        # # pprint(stack[2][0]) #auto_run
        # # pprint(stack[2][0].f_locals)#bolt4x1
        # pprint(stack[3][0])#auto_run
        # pprint(stack[3][1])
        ...
        # print("what's this")
        # pprint(inspect.currentframe())
        # print("calframe 2")
        # pprint(inspect.getouterframes(curframe, 2))
        # print("calframe 1")
        # pprint(inspect.getouterframes(curframe, 1))
        # # print("============  THe attr ==================")
        # # for attr in dir(the_object):
        #     if not callable(getattr(the_object,attr)):
        #         # pprint(the_object.(globals()[attr]))
        #         # (the_object.globals()[attr])

        # if (type(the_object) == 'collections.deque'):
            # for key in the_object.__dict__.keys()):
            #     # self.ready(the_object[key])
